...
module.exports.supportedOptions = {
    ...
    // OpenObserve URL. Enables storing of request response records in OpenObserve.
    // Default is empty (disabled).
    openobserve: "openobserve",

    // Prefix for OpenObserve index. Default is "api-"
    openobserveIndexPrefix: "openobserveIndexPrefix",

    // Username for OpenObserve, if anonymous user is disbaled . Default is empty (disabled)
    openobserveUsername: "openobserveUsername",

    // Password for OpenObserve, if anonymous user is disbaled . Default is empty (disabled)
